...
class GreedySearchDecoderOnlyOutput(ModelOutput):
    ...
    Args:
        ...
        logits (`tuple(torch.FloatTensor)` *optional*, returned when `output_scores=True` is passed or when `config.output_scores=True`):
    """
    ...
    def sample(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            processed_next_token_logits = next_token_scores
            ...
            if return_dict_in_generate:
                if output_scores:
                    ...
                    logits += (processed_next_token_logits,)
                if output_attentions:
                    decoder_attentions += (
                        (outputs.decoder_attentions,) if self.config.is_encoder_decoder else (outputs.attentions,)
                    )
